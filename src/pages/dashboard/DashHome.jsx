...
const DashHome = () => {
    ...
    return (
        <div>
            <Container maxW='100%' textAlign='left'display='flex' flexDirection='column' gap='10px' >
                <Text fontSize='xx-large' >Welcome!</Text>
                <Box padding='20px'><Button bg='blue.600' color='white'  onClick={handleTabChange} >Upload New Product</Button></Box>
